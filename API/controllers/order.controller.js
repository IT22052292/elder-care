...
export const createOrder = async (req, res, next) => {
  try {
    ...
    const existingOrder = await Order.findOne({
      ...
      orderStatus: { $ne: 'Fulfilled' }, //Dinding for orders that are not  fulfilled
    });
...
export const getOrdersByMonth = async (req, res) => {
  ...
  try {
    ...
    //getting orders within the specified date range
...
export const getOrdersByUserName = async (req, res, next) => {
  try {
